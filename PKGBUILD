...
license=('MIT')
arch=('i686' 'x86_64')
[[ "${CHOST}" =~ '-linux' ]] && arch+=('armv6h' 'armv7h' 'aarch64')
...
source_armv6h=("https://github.com/rclone/rclone/releases/download/v$pkgver/rclone-v$pkgver-linux-arm-v6.zip")
source_armv7h=("https://github.com/rclone/rclone/releases/download/v$pkgver/rclone-v$pkgver-linux-arm-v7.zip")
